  ...
  return (
    <div className="container">
      ...
      <p className="paragraph">
        ...
        to ensure your constitutional rights are upheld, including: 
        </p>
        <ul className="list">
        <li>Fourth Amendment: Protection from warrantless searches and seizures </li>
        <li>Fifth Amendment: Your right to remain silent and due process </li>
        <li>Sixth Amendment: Your right to legal representation</li>
        </ul>
        <p className="paragraph"> She will interview witnesses, review
