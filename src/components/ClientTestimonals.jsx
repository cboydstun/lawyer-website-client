    ...
    <div style={{ backgroundColor: "gray" }}>
      ...
      <div>
        ...
        <p className="text-lg font bold text-justify">
          ...
          communicative, responsive, and professional throughout. She was able
          to give genuine advice which helped me get through this legal process
          with minimal stress and loss to my present and future assets. I'll
          always be grateful. I give Ms. Kriebel my highest recommendation. -
      ...
      <div>
        ...
        <p className="text-lg font bold text-justify">
          ...
          and was unsure how to go about hiring one my husband and I could trust
          not to take us for a ride. I found Jacqueline Kriebel on avvo.com and
          saw her amazing reviews. Her clients are right about her. When I
          called she personally answered. I was expecting to speak to an
          assistant and not the attorney herself. I was impressed immediately!
          Jacqueline answered my questions patiently and made me feel at ease
          right away. My husband and I didn't want to drag out our divorce.
          Jacqueline filed our paperwork and finalized just past the 60-day
          waiting period. Our divorce was quick, easy, and legally painless. If
          you need someone who will truly do a reasonable and quick divorce, I
      ...
      <div>
        ...
        <p className="text-lg font bold text-justify">
          ...
          case. She was right up front about the outcome and fought our rights.
          Whenever we called and could not talk to her she would always return
          our calls. All I can say is that she is GREAT!!!! She is a asset to
          the legal profession!! If I ever need an attorney you can bet she will
          be the one that I call. Jacqueline Kriebel WON our case and we want to
